! function () {
    ...
    function g(r, e, o, s) {
        ...
        return e.forEach(function (e, n) {
            if ("heading" === e.type && e.depth <= s) {
                ...
                }), a && (p = a.replace(/<!-- {docsify-ignore} -->/, "").replace(/{docsify-ignore}/, "").replace(/<!-- {docsify-ignore-all} -->/, "").replace(/{docsify-ignore-all}/, "").trim()), l[c] = {
                    slug: c,
                    title: p,
                    body: ""
                }
    ...
    function c(e) {
        ...
        if (!e) return t.classList.remove("show"), a.classList.remove("show"), t.innerHTML = "", void(o.hideOtherSidebarContent && (i.classList.remove("hide"), n.classList.remove("hide")));
        var e = function (e) {
                var n = [],
                    t = [];
                ...
                for (var i = 0; i < t.length; i++) ! function (e) {
                    ...
                    d && (a.forEach(function (e) {
                        var n, t = new RegExp(p(e).replace(/[|\\{}()[\]^$+*?.]/g, "\\$&"), "gi"),
                            a = -1,
                            i = -1;
                        s = d ? p(d) : d, c = l ? p(l) : l, a = d ? s.search(t) : -1, i = l ? c.search(t) : -1, (0 <= a || 0 <= i) && (r += 0 <= a ? 3 : 0 <= i ? 2 : 0, i < 0 && (i = 0), a = (a = n = 0) == (n = i < 11 ? 0 : i - 10) ? 70 : i + e.length + 60, l && a > l.length && (a = l.length), t = "..." + c.substring(n, a).replace(t, function (e) {
        ...
        }), t.classList.add("show"), a.classList.add("show"), t.innerHTML = r || '<p class="empty">' + s + "</p>", o.hideOtherSidebarContent && (i.classList.add("hide"), n.classList.add("hide"))
    }
